...
"""
作用: 1. 每日baostock接口更新中证500组成成分
      2. 存入数据库./db/stock.db BAOSTOCK_ZZ500表中
用法:
- baostock_zz500_update()
    - 每日更新中证500组成成分从baostock
    - updateDate    |   code    |   code_name
        2021-10-18    sz.300618     寒锐钴
"""
...
def baostock_zz500_update(sql_table_name = "BAOSTOCK_ZZ500"):
    # 从baostock下载中证500成分
    lg = bs.login()  # 登陆
